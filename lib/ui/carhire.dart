...
class CarHireScreen extends StatefulWidget {
  @override
  CarHireScreenState createState() => CarHireScreenState();
}

class CarHireScreenState extends State<CarHireScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(StringConstants.carHire,style: TextStyle(color: ColorConstants.blackColor),),
      ),
      body:  Stack(children: [
        BackgroundWidget(),
